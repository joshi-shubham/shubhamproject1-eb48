[shubhamproject1-eb48] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [shubhamproject1-eb48] container is NOT running**.

.. tip::
   You must have your [shubhamproject1-eb48] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/joshi-shubham/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/joshi-shubham/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=42129  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='joshi-shubham'  \-\-env DOCKERUSERNAME='shubjoshi'  \-\-env MQTTUSERNAME='shubjoshi2056@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   shubjoshi/shubhamproject1-eb48-amd64 (https://hub.docker.com/r/shubjoshi/shubhamproject1-eb48-amd64)
...
.. important::
   docker run -d -p 41207:41207 -p 44049:44049 -p 52677:52677 \-\-env TSS=0 \-\-env SOLUTIONNAME=shubhamproject1-eb48 \-\-env SOLUTIONDAG=solution_preprocessing_dag-shubhamproject1-eb48 \-\-env GITUSERNAME=joshi-shubham  \-\-env GITREPOURL=https://github.com/joshi-shubham/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=41207  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=44049  \-\-env SOLUTIONVIPERVIZPORT=52677 \-\-env DOCKERUSERNAME='shubjoshi'  \-\-env EXTERNALPORT=42129 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='shubjoshi2056@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  shubjoshi/shubhamproject1-eb48-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=52677
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=41207
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - shubjoshi/shubhamproject1-eb48-amd64
...
It can be accessed by entering: http://localhost:44049
...
.. important::
   http://localhost:52677/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:52677/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:52677/<html file>
...
[shubhamproject1-eb48] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/joshi-shubham/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/shubhamproject1-eb48
...
.. important::
   https://shubhamproject1-eb48.readthedocs.io
...
.. important::
   solution_preprocessing_dag-shubhamproject1-eb48
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=41207, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42797, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33403, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42501, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45527, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=42421, HPDEHOST=127.0.1.1, HPDEPORT=40979, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44375

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6145-shubhamproject1-eb48,solution_preprocessing_dag-shubhamproject1-eb48, python-preprocess-9599-shubhamproject1-eb48,solution_preprocessing_dag-shubhamproject1-eb48, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
